...
public class Empleado {
	...
	public void visualizar(){
		...
		Leer.mostrarEnPantalla("Nacimiento: " + fechaNacimiento.fechaTexto());
		System.out.printf("Numero de empleado: %02d\n",numeroEmpleado);
		Leer.mostrarEnPantalla("Fecha de ingreso: "+fechaIngreso.fechaTexto());
	}
}
